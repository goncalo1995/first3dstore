  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#121212] text-white">
      ...
      <section id="galeria" className="px-5 py-16 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <p className="font-sans text-sm font-semibold uppercase tracking-[0.22em] text-[#ffaa00]">Galeria de Inspiração</p>
            <h2 className="mt-3 font-serif text-3xl font-bold tracking-tight text-white sm:text-5xl">Veja como as nossas esculturas de luz transformam qualquer espaço.</h2>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {galleryItems.map((item) => (
              <article key={item.title} className="group relative overflow-hidden rounded-lg border border-white/10 bg-white/8">
